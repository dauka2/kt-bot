...
def call_back(bot, call):
    if call.data == 'Айтыңызшы!':
        ...
        bot.send_document(call.message.chat.id, open('images/PDF-1 kaz (наша история) - 1.jpg', 'rb'))
        bot.send_document(call.message.chat.id, open('images/PDF-1 kaz (наша история) - 2.jpg', 'rb'))
        time.sleep(0.75)
        markup_callback = types.InlineKeyboardMarkup()
